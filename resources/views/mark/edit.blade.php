...
@section('content')
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            @endif
            {!! Form::model($mark, ['method' => 'PATCH','route' => ['marks-management.update', $mark->id],'id' =>'validation-form-mark']) !!}
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group">
                        <strong>Name:</strong>{{ Form::select('student', $students, $mark->student, array('class'=>'form-control', 'placeholder'=>'Please select Student')) }}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <div class="form-group"><strong>Term:</strong>
                        {{ Form::select('term', $terms, $mark->term, array('class'=>'form-control', 'placeholder'=>'Please select Term')) }}
                    </div>
                </div>
